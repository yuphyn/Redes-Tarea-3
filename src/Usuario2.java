        ...
        if(entradaTeclado.equals("1") ) {
            ...
            while (true) {
                ...
                try {
                    ...
                    Thread t = new ClientHandler(socket, in, out,transmision1, transmision2);
...
class ClientHandler extends Thread
{
    ...
    // Constructor
    public ClientHandler(Socket s, DataInputStream in, DataOutputStream out, Socket transmision1, Socket transmision2)
    {
        this.s = s;
        this.in = in;
        this.out = out;
